...
const PAWN_KPIS = [
  ...
  { name: "num_pawns_renewed_30d", label: "# Pawns Renewed" },
  { name: "dollar_pawns_renewed_30d", label: "$ Pawns Renewed" },
  { name: "num_buys_30d", label: "# Buys" },
  { name: "dollar_buys_30d", label: "$ Buys" },
...
const KpiUpload = () => {
  ...
  const {
    ...
    marketingKpis,
    pawnPerformanceKpis,
    merchandisePerformanceKpis,
    financialSummaryKpis,
    customerMarketingKpis,
    fieldNameToCategory,
